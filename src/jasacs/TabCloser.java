...
public class TabCloser extends JTabbedPane
{
    ...
    implements MouseListener, MouseMotionListener
  {
    ...
    public TabCloseUI(TabCloser pane) {
    ...
    public void mouseReleased(MouseEvent me) { if (closeUnderMouse(me.getX(), me.getY())) {
        boolean isToCloseTab = TabCloser.this.tabAboutToClose(this.selectedTab);
